                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <table id="category-table" data-toggle="table"
                                data-url="<c:url value='/category/ajaxGetCategoriesByParent' /><c:if test="${parentOid != null }">?parentOid=${parentOid }</c:if>"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="isLeaf" data-align="center" data-formatter="statusFormatter">叶子节点</th>
