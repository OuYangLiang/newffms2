	                        ...
	                        <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7 col-sm-4">
                                        <spring:select path="consumption.cpnType" class="form-control" id="cpnTypeInput">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7 col-sm-4">
                                        <div class='input-group date' id='cpnTimeInputPicker'>
                                            <spring:input path="consumption.cpnTimeInput" id="cpnTimeInput" class="form-control" data-validation-engine="validate[required]" />
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <button type="button" class="btn btn-default" id="btn-add-item"><i class="glyphicon glyphicon-plus"></i></button>
                                </div>
                            </div>
	                                ...
	                                <div class="col-sm-6" id="item${status.index}">
	                                    <div class="box box-default">
	                                        <div class="box-header with-border">
								                ...
								                <div class="box-tools pull-right">
								                    <button type="button" class="btn btn-box-tool" id="remove-item${status.index}" onClick="javascript:removeItem(${status.index });"><i class="fa fa-times"></i></button>
								                </div>
								            </div>
	                                        <div class="box-body">
	                                            <div class="form-horizontal">
                                                    <div class="form-group">
					                                    <div class="col-sm-6">
					                                        <spring:input class="form-control" placeholder="说明" data-validation-engine="validate[required]" id="itemDesc${status.index }" path="cpnItems[${status.index }].itemDesc" maxlength="30" />
					                                    </div>
					                                    
                                                        <div class="col-sm-6">
                                                            <spring:input class="form-control" placeholder="类别" data-validation-engine="validate[required]" id="categoryDesc${status.index }" path="cpnItems[${status.index }].categoryDesc" onClick="javascript:selectCategory(${status.index });" />
                                                            <input type="hidden" id="categoryOid${status.index }" name="cpnItems[${status.index }].categoryOid" value="${item.categoryOid }" />
                                                        </div>
                                                        
                                                        <div class="col-sm-6">
                                                            <spring:input class="form-control" placeholder="金额" data-validation-engine="validate[required]" id="itemAmount${status.index }" path="cpnItems[${status.index }].amount" onBlur="javascript:checkItemAmount(this);" maxlength="11" />
                                                        </div>
                                                        
                                                        <div class="col-sm-6">
                                                            <spring:select class="form-control" placeholder="消费人" data-validation-engine="validate[required]" id="itemOwner${status.index }" path='cpnItems[${status.index }].ownerOid' >
                                                                <spring:option value="" label="请选择"/>
                    ...
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <button type="button" class="btn btn-default" id="btn-add-account"><i class="glyphicon glyphicon-plus"></i></button>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-6" id="account${status.index}">
                                        <div class="box box-default">
                                            <div class="box-header with-border">
                                                ...
                                                <div class="box-tools pull-right">
                                                    <button type="button" class="btn btn-box-tool" id="remove-account${status.index}" onClick="javascript:removeAccount(${status.index});"><i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <spring:input class="form-control" placeholder="支付金额" data-validation-engine="validate[required]" id="payment${status.index }" path="accounts[${status.index }].payment" onBlur="javascript:checkAccountAmount(this);" maxlength="11" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            $( document ).ready(function() {
                ...
                var itemTemplate = "<div class=\"col-sm-6\" id=\"item\#{itemSeq}\">" +
                	...
                	"<div class=\"form-group\">" +
                	"<div class=\"col-sm-6\">" +
                	"<input type=\"text\" class=\"form-control\" placeholder=\"说明\" data-validation-engine=\"validate[required]\" id=\"itemDesc\#{itemSeq}\" name=\"cpnItems[\#{itemSeq}].itemDesc\" maxlength=\"30\" />" +
                	"</div>" +
                	"<div class=\"col-sm-6\">" +
                	"<input type=\"text\" class=\"form-control\" placeholder=\"类别\" data-validation-engine=\"validate[required]\" id=\"categoryDesc\#{itemSeq}\" name=\"cpnItems[\#{itemSeq}].categoryDesc\" onClick=\"javascript:selectCategory(\#{itemSeq});\" />" +
                	"<input type=\"hidden\" id=\"categoryOid\#{itemSeq}\" name=\"cpnItems[\#{itemSeq}].categoryOid\" />" +
                	"</div>" +
                	"<div class=\"col-sm-6\">" +
                	"<input type=\"text\" class=\"form-control\" placeholder=\"金额\" data-validation-engine=\"validate[required]\" id=\"itemAmount\#{itemSeq}\" name=\"cpnItems[\#{itemSeq}].amount\" onBlur=\"javascript:checkItemAmount(this);\" maxlength=\"11\" />" +
                	"</div>" +
                	"<div class=\"col-sm-6\">" +
                	"<select class=\"form-control\" placeholder=\"消费人\" data-validation-engine=\"validate[required]\" id=\"itemOwner\#{itemSeq}\" name='cpnItems[\#{itemSeq}].ownerOid' >" +
	            ...
	            accountCnt = ${ cpnForm.accounts.size() };
