	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-3">
	                                        <div class='input-group date' id='cpnTimeFromInputPicker'>
	                                            <input id="cpnTimeFromInput" class="form-control" value="<fmt:formatDate value='${SESSION_KEY_SEARCH_PARAM_CONSUMPTIONITEM.consumption.cpnTimeFrom }' pattern="yyyy-MM-dd" />" type="text" name="cpnTimeFrom" />
	                                    ...
	                                    <div class="col-sm-3">
	                                        <div class='input-group date' id='cpnTimeToInputPicker'>
	                                            <input id="cpnTimeToInput" class="form-control" value="<fmt:formatDate value='${SESSION_KEY_SEARCH_PARAM_CONSUMPTIONITEM.consumption.cpnTimeTo }' pattern="yyyy-MM-dd" />" type="text" name="cpnTimeTo" />
	                                            <span class="input-group-addon">
	                                                <span class="glyphicon glyphicon-calendar"></span>
	                                            </span>
	                                        </div>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <table id="data-table" data-toggle="table"
                                ...
                                data-sort-name="<c:url value='${SESSION_KEY_SEARCH_PARAM_CONSUMPTIONITEM.sortField}' />"
                                data-sort-order="<c:url value='${SESSION_KEY_SEARCH_PARAM_CONSUMPTIONITEM.sortDir}' />"
                                data-page-size="<c:url value='${SESSION_KEY_SEARCH_PARAM_CONSUMPTIONITEM.sizePerPage}' />"
                                data-page-number="<c:url value='${SESSION_KEY_SEARCH_PARAM_CONSUMPTIONITEM.requestPage}' />"
