            ...
            <spring:form id="form" class="form-horizontal" method="post" action="${url}" modelAttribute="incomingForm" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-7 col-sm-4">
                  <spring:select path="owner.userOid" class="form-control" id="userNameInput">
              ...
              <div class="form-group" id="debt">
                ...
                <div class="col-xs-7 col-sm-4">
                  <input data-validation-engine="validate[required]" id="targetAccountInput" value="<c:out value='${incomingForm.targetAccount.acntHumanDesc }' />"
                        class="form-control" readonly="true" data-toggle="modal" data-target="#AccountSelectModal" />
