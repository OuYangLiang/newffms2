...
<head>
<link
  href="<c:url value='/bootstrap-table-1.10.1/bootstrap-table.min.css' />"
  rel="stylesheet">
</head>
        ...
        <div class="box box-primary">
          <div class="box-body">
            ...
            <table id="data-table" data-toggle="table"
              ...
              data-sort-name="<c:url value='${SESSION_KEY_SEARCH_PARAM_INCOMING.paginationParameter.sortField}' />"
              data-sort-order="<c:url value='${SESSION_KEY_SEARCH_PARAM_INCOMING.paginationParameter.sortDir}' />"
              data-page-size="<c:url value='${SESSION_KEY_SEARCH_PARAM_INCOMING.paginationParameter.sizePerPage}' />"
              data-page-number="<c:url value='${SESSION_KEY_SEARCH_PARAM_INCOMING.paginationParameter.requestPage}' />"
              ...
              <thead>
                <tr>
                  ...
                  <th data-field="incomingTypeDesc">收入类型</th>
        ...
        <div class="modal-body">
          <div class="container-fluid">
            <form id="search-form" class="form-horizontal">
              ...
              <div class="form-group">
                <label for="confirmedInput"
                  class="col-md-3 control-label">状态</label>
                <div class="col-md-4">
                  ...
                  <select name="incomingType" class="form-control" id="incomingTypeInput">
                    ...
                    <c:forEach var="item" items="${ incomingTypes }" varStatus="status">
                      <option value="${item.key }"
                        <c:if test='${item.key == SESSION_KEY_SEARCH_PARAM_INCOMING.incomingType }' >selected="selected"</c:if>>${item.value }</option>
                    </c:forEach>
                  </select>
                </div>
              </div>
